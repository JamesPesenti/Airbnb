...
const [results, setResults] = useState("")
 ...
 // When property results render
  ...
  return (
    <>
      <ScrollView>
      <Text style={{fontSize: 18, textAlign: "center", color: "gainsboro", marginBottom: 10}}>Here are some recommended properties</Text>
      <View style={styles.reservationCard}>
          <View style={{width: "100%", height: "50%", overflow: "hidden"}}>
           ...
           <View style={styles.daysContainer}>
            {/* <Text style={styles.days}>{reservations.days}</Text> */}
           </View>
          </View>
