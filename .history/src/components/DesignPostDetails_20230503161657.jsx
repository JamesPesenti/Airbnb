...
const DesignPostDetails = ({ designPost }) => {
  ...
  // const [delayedDesignPost, setDelayedDesignPost] = useState(null)
  ...
  // useEffect(() => {
  //   if (isMounted) {
  //     setDelayedDesignPost(designPost)
  //   }
  // }, [isMounted, designPost])

  // if (!delayedDesignPost) {
  //   return null
  // }
           ...
           <View style={styles.reserveButtonContainer}>
            <View style={{flexDirection: "row"}}>
              ...
              <Pressable
                  ...
                  onPress={navigation.navigate("DesignCategory")}
              >
