        ...
        <>
         <View style={{top: 40, left: 10}}>
          <Pressable onPress={() => navigation.goBack()}>
            <Image 
              source={{ uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSslQX7cmdYJtQHvrZYtCnLuVITe8pb2jrNFA&usqp=CAU" }}
              style={{width: 25, height: 25, borderRadius: 100, resizeMode: "contain"}}
            />
          </Pressable>
         </View>
        </>
