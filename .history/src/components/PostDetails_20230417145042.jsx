...
const PostDetails = ({ designPost }) => {
  ...
  const heartButton = () => {
    return(
      <>
       <View style={{top: 8, left: 200, padding: 8, backgroundColor: "white", borderRadius: 100,}}>
        <Pressable onPress={() => navigation.goBack()}>
          <Image 
            ...
            style={{width: 20, height: 20, right: 1}}
          />
        </Pressable>
       </View>
      </>
