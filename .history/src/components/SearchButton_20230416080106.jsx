  ...
  return (
    <>
      ...
      >
         ...
         <View style={{padding: 10, justifyContent: "center", marginLeft: 10}}>
          <Image 
            style={{ width: 25, height: 25, resizeMode: "cover", borderWidth: 1, borderColor: "lightgrey", borderRadius: 50}}
