...
const SearchBackButton = () => {
  ...
  const navigation = useNavigation()
   ...
   return(
     <>
      <View style={{marginHorizontal: 163, top: 20, right: 147, padding: 7, backgroundColor: "white", borderRadius: 100,}}>
       <Pressable onPress={() => navigation.goBack()}>
         <Image 
           source={{ uri: "https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-ios7-arrow-back-512.png" }}
           style={{width: 22, height: 22, right: 2}}
         />
       </Pressable>
      </View>
     </>
...
export { BackButton, SearchBackButton, HeartButton }