import { Dimensions, StyleSheet, ScrollView, Image, Text, View, TextInput, Pressable, Alert } from 'react-native'
    ...
    return (
      <>
        ...
        <View style={styles.resultContainer}>
         <Text style={{fontSize: 18, textAlign: "center",}}>Here are some recommended properties</Text>
          <View>
