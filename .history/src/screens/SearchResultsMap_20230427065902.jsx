  ...
  return (
   <View style={{flex: 1}}>
     <View style={{flex: 1, position: 'relative'}}>
       ...
       <View style={{position: "absolute", top: 30, left: 0, zIndex: 1}}>
         {backButton()}
       </View>
     </View>
